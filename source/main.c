...
void printHelp() {
    printf("Справка по использованию программы: \n"
           ...
           "Данная справка:                                    -h / --help\n"
           "Выбора цвета:                                      -c / --color\n"
           "Цвет, который требуется поменять:                  -f / --from\n"
           "Цвет, на который требуется поменять:               -t / --to\n"
           "Поиск всех прямоугольников заданного цвета:        -r / --rect\n"
           "Замена всех пикселей одного цвета на другой цвет:  -p / --paint\n"
           "Рамка вокруг изображения:                          -F / --frame\n"
           "Толщина рамки:                                     -s / --width\n"
           "Толщина прямой для обводки прямоугольников(1-9):   -T\n"
           "Цвет рамки:                                        -C\n"
